...
import { submarineMenu } from '@/lib/data';
...
const SubmarineMenuModal: React.FC<MenuModalProps> = ({ 
  isOpen, 
  onClose, 
  title, 
  description, 
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-restaurant-red">
                <th className="py-2 px-4 text-left text-white">Styles</th>
          ...
          <div className="mt-8">
            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead>
                  <tr className="border-b border-restaurant-red">
                    <th className="py-2 px-4 text-center text-white">Styles</th>
                    <th className="py-2 px-4 text-center text-white">10"</th>
                    <th className="py-2 px-4 text-center text-white">14"</th>
                  </tr>
                </thead>
...
export default SubmarineMenuModal;